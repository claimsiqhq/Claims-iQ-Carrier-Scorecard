...
<div style="max-width:600px;margin:0 auto;background:#fff;">
  ...
  <div style="background-color:#342A4F;padding:12px 24px;text-align:center;">
    <p style="margin:0;font-size:11px;color:#9D8BBF;">Generated by Complete iQ</p>
  </div>
</div>
</body></html>`;
}
...
export function renderAuditEmail(data: EmailData): string {
  ...
  const headerTitle = isAllstate
    ...
    : "Complete iQ Carrier Audit Result";
...
<body style="margin:0;padding:0;background-color:#f0edf4;font-family:Arial,Helvetica,sans-serif;">
  <div style="max-width:640px;margin:0 auto;background-color:#ffffff;">
    ...
    <div style="background-color:#342A4F;padding:16px 32px;text-align:center;">
      <p style="margin:0;font-size:12px;color:#9D8BBF;">Generated by Complete iQ Carrier Audit</p>
    </div>
  </div>
</body>
</html>`;
