...
import { ArrowLeft, PageSearch } from "iconoir-react"
  ...
  return (
    <div className="ciq-page">
      <div className="flex min-h-full items-center justify-center p-6">
        <section className="ciq-panel max-w-lg border-t-[3px] border-t-[var(--ciq-brand)] p-8 text-center">
